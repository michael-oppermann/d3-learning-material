class Scatterplot {
  ...
  initVis() {
    ...
    vis.shapeScale = d3.scaleOrdinal()
        .range([d3.symbol().type(d3.symbolCircle)(), d3.symbol().type(d3.symbolSquare)(), d3.symbol().type(d3.symbolDiamond)()])
        .domain(['Easy', 'Intermediate', 'Difficult']);
  ...
  updateVis() {
    ...
    vis.trailCategory = d => d.difficulty;
    vis.xValue = d => d.time;
  ...
  renderVis() {
    ...
    vis.chart.selectAll('.symbol')
      ...
      .append('path')
        ...
        .attr('d', d => vis.shapeScale(vis.trailCategory(d)))
        .attr('fill', d => vis.colorScale(vis.trailCategory(d)));
